...
const shopProducts = [
  { id: "1", title: "Pearl Huggies", price: 1199, image: "/images/product-earrings.jpg", tag: "NEW" },
  { id: "2", title: "Golden Heart Drops", price: 1299, image: "/images/product-earrings.jpg", tag: "BESTSELLER" },
  { id: "3", title: "Mini Flora Studs", price: 1099, image: "/images/product-earrings.jpg", tag: "" },
  { id: "4", title: "Twist Hoops", price: 1299, image: "/images/product-earrings.jpg", tag: "" },
  { id: "5", title: "Ruby Glow Ring", price: 1399, image: "/images/product-ring.jpg", tag: "NEW" },
  { id: "6", title: "Classic Hoops", price: 999, image: "/images/product-earrings.jpg", tag: "" },
  { id: "7", title: "Layered Star Necklace", price: 1299, image: "/images/product-necklace.jpg", tag: "BESTSELLER" },
  { id: "8", title: "Butterfly Studs", price: 1099, image: "/images/product-earrings.jpg", tag: "" },
  { id: "9", title: "Emerald Drop Earrings", price: 1499, image: "/images/product-earrings.jpg", tag: "NEW" },
  { id: "10", title: "Diamond Accent Ring", price: 2199, image: "/images/product-ring.jpg", tag: "" },
  { id: "11", title: "Gold Chain Link", price: 1599, image: "/images/product-necklace.jpg", tag: "" },
  { id: "12", title: "Pearl Pendant", price: 1299, image: "/images/product-necklace.jpg", tag: "BESTSELLER" },
];
    ...
    <PageTransition>
      <div className="min-h-screen bg-[#FDFCF8]">
        ...
        <div className="relative w-full h-[35vh] min-h-[250px] flex items-center justify-center overflow-hidden border-y border-[#E8DED0]">
          ...
          <div className="absolute inset-0 bg-[url('/images/ugc-hero.jpg')] opacity-10 mix-blend-multiply bg-cover bg-center z-0" />
          ...
          <div className="flex gap-10">
            ...
            <div className="hidden lg:block w-64 flex-shrink-0">
              <div className="sticky top-28 space-y-10">
                ...
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-[0.1em] text-[#1e1e1e] mb-4 pb-2 border-b border-[#E8DED0]">Material</h3>
                    ...
                    {['18k Gold Plated', 'Sterling Silver', 'Rose Gold', 'Mixed Metal'].map(mat => (
                      <li key={mat}>
                        <label className="flex items-center gap-3 cursor-pointer group">
                          ...
                          <span className="text-sm md:text-[15px] text-[#666] group-hover:text-[#E30613] transition-colors">{mat}</span>
                        </label>
                      </li>
                    ))}
                  </ul>
                ...
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-[0.1em] text-[#1e1e1e] mb-4 pb-2 border-b border-[#E8DED0]">Price Range</h3>
                  <ul className="space-y-3">
                    {['Under ₹1000', '₹1000 - ₹2000', '₹2000 - ₹5000', 'Over ₹5000'].map(price => (
                      <li key={price}>
                        <label className="flex items-center gap-3 cursor-pointer group">
                          <input type="checkbox" className="w-3.5 h-3.5 border border-[#E8DED0] rounded-sm checked:bg-[#E30613] checked:border-[#E30613] appearance-none" />
                          <span className="text-sm md:text-[15px] text-[#666] group-hover:text-[#E30613] transition-colors">{price}</span>
                        </label>
                      </li>
                    ))}
                  </ul>
                ...
                <div>
                  <h3 className="text-xs font-bold uppercase tracking-[0.1em] text-[#1e1e1e] mb-4 pb-2 border-b border-[#E8DED0]">Style</h3>
                  <ul className="space-y-3">
                    {['Minimalist', 'Statement', 'Vintage Inspired', 'Everyday Wear'].map(style => (
                      <li key={style}>
                        <label className="flex items-center gap-3 cursor-pointer group">
                          <input type="checkbox" className="w-3.5 h-3.5 border border-[#E8DED0] rounded-sm checked:bg-[#E30613] checked:border-[#E30613] appearance-none" />
                          <span className="text-sm md:text-[15px] text-[#666] group-hover:text-[#E30613] transition-colors">{style}</span>
                        </label>
                      </li>
                    ))}
                  </ul>
            ...
            <div className="flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
                {shopProducts.map((prod) => (
                  <Link href={`/products/${prod.title.toLowerCase().replace(/ /g, '-')}`} key={prod.id} className="group flex flex-col space-y-3">
                    <div className="bg-[#F9F9F9] aspect-[4/5] relative overflow-hidden flex items-center justify-center">
                      ...
                      <img src={prod.image} alt={prod.title} className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover:scale-105" />
                    </div>
                    <div className="flex flex-col space-y-1 pt-2">
                      ...
                      <p className="font-sans text-sm md:text-base text-neutral-600 font-light">₹{prod.price.toLocaleString('en-IN')}</p>
                    </div>
                  </Link>
                ))}
              </div>
